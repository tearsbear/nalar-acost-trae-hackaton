      ...
      <div className="relative z-10 w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-[22px] font-semibold tracking-tight text-white">
            {error === "CONFIRM_EMAIL" ? "Check your email" : "Create your account"}
          </h1>
          ...
          {error === "CONFIRM_EMAIL" ? (
            <div className="text-center py-2">
              ...
              <div className="mt-8 flex flex-col gap-3">
                <Link 
                  href="/login"
                  className="h-10 w-full flex items-center justify-center rounded-[10px] bg-white text-sm font-semibold text-black transition-opacity hover:opacity-90"
                >
                  Go to login
                </Link>
                <button
