...
import { LayoutDashboard, ScrollText, Lightbulb, Settings } from "lucide-react"
  ...
  return (
    <aside className="flex h-full w-52 flex-col border-r border-[#e5e5e5] bg-white">
      ...
      <div className="border-t border-[#e5e5e5] p-2.5">
        <div className="flex items-center gap-2.5 rounded-[10px] px-3 py-2.5 hover:bg-[#f2f2f2] transition-colors cursor-pointer">
